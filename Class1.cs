    ...
    public class GHExportFDS : GH_Component
    {
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            if (export)
            {
                ...
                string meshline = "&MESH" + (meshcorner[0][0] - origin[0]).ToString() + "," + (meshcorner[1][0] - origin[0]).ToString() + "," + (meshcorner[0][1] - origin[1]).ToString() + "," + (meshcorner[2][1] - origin[1]).ToString() + "," + (meshcorner[0][2] - origin[2]) + "," + (meshcorner[4][2] - origin[2]).ToString() + "," + " IJK=" + ijk[0].ToString() + "," + ijk[1].ToString() + "," + ijk[2].ToString() + " /";
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return GHWind.Properties.Resources.smile;
            }
        }
